                    ...
                    <div class="space-y-4">
                        <div class="flex flex-col space-y-4">
                            ...
                            <button id="convert-button" onclick="checkAndConvert()"
                                ...
                                <span id="convert-button-text">Convert to MilesCoin</span>
                            </button>
...
function updateConvertButtonState(statusData) {
    ...
    if (statusData.can_convert) {
        ...
        convertButton.classList.remove('opacity-50', 'cursor-not-allowed');
                        buttonText.textContent = 'Convert to MilesCoin';
                        ...
                        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 transform transition-all">
                            <div class="text-center">
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 mb-4">
                                    <div class="space-y-2 text-sm">
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Amount Converted:</span>
                                            <span class="font-medium text-gray-900">${amount} TRX</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Conversion Fee (1%):</span>
                                            <span class="font-medium text-red-600">${(amount * 0.01).toFixed(6)} TRX</span>
                                        </div>
                                        <div class="border-t border-gray-200 pt-2 flex justify-between">
                                            <span class="text-gray-600 font-medium">You Received:</span>
                                            <span class="font-bold text-green-600">${(amount * 0.99).toFixed(6)} MSC</span>
                                        </div>
                                    </div>
                                </div>
